...
namespace GarageManagement.Server.Migrations
{
    ...
    [Migration("20260316072851_AddedInwardTables")]
    partial class AddedInwardTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GarageManagement.Server.Model.InwardNote", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("WorkshopId", "InwardNo")
                        .IsUnique()
                        .HasFilter("[WorkshopId] IS NOT NULL");

                    b.ToTable("InwardNote", (string)null);
                });

            modelBuilder.Entity("GarageManagement.Server.Model.InwardNoteItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("InwardNoteId");

                    b.ToTable("InwardNoteItem", (string)null);
                });
            ...
            modelBuilder.Entity("GarageManagement.Server.Model.PurchaseOrder", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("GarageManagement.Server.Model.PurchaseOrderItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("GarageManagement.Server.Model.Supplier", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("GarageManagement.Server.Model.InwardNote", b =>
                {
                    b.HasOne("GarageManagement.Server.Model.Supplier", "Supplier")
                        .WithMany()
            ...
            modelBuilder.Entity("GarageManagement.Server.Model.InwardNoteItem", b =>
                {
                    b.HasOne("GarageManagement.Server.Model.InwardNote", "InwardNote")
                        .WithMany("Items")
                        .HasForeignKey("InwardNoteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("InwardNote");
                });
            ...
            modelBuilder.Entity("GarageManagement.Server.Model.PurchaseOrderItem", b =>
                {
                    b.HasOne("GarageManagement.Server.Model.PurchaseOrder", "PurchaseOrder")
                        .WithMany("Items")
